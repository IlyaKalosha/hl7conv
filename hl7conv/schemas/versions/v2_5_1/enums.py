...
class Queryorresponseformatcode(str, Enum):
     """
     0106 - Query or response format code
...
class Yesornoindicator(str, Enum):
     """
     0136 - Yes or no indicator
...
class MilitaryRankorGrade(str, Enum):
     """
     0141 - Military Rank or Grade
...
class Acceptorapplicationacknowledgmentconditions(str, Enum):
     """
     0155 - Accept or application acknowledgment conditions
...
class Whichdateortimequalifier(str, Enum):
     """
     0156 - Which date or time qualifier
...
class Whichdateortimestatusqualifier(str, Enum):
     """
     0157 - Which date or time status qualifier
...
class Dateortimeselectionqualifier(str, Enum):
     """
...
class NatureofServiceorTestorObservation(str, Enum):
     """
...
class ActiveorInactive(str, Enum):
     """
     0183 - Active or Inactive
...
class ProblemorGoalActionCode(str, Enum):
     """
...
class Degreeorlicenseorcertificate(str, Enum):
     """
     0360 - Degree or license or certificate
