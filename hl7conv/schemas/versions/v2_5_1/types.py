...
class CodedWithExceptions(BaseModel):
    ...
    cwe_6: Codingsystem = Field(None, alias="6", description='Name Of Alternate Coding System')
    cwe_7: str = Field(None, alias="7", description='Coding System Version Id')
    cwe_8: str = Field(None, alias="8", description='Alternate Coding System Version Id')
...
class ExtendedAddress(BaseModel):
    ...
    xad_11: Name_addressrepresentation = Field(None, alias="11", description='Address Representation Code')
    xad_12: DateAndTimeRange = Field(None, alias="12", description='Address Validity Range')
...
class ExtendedCompositeNameAndIdentificationNumberForOrganizations(BaseModel):
    ...
    xon_2: Organizationalnametype = Field(None, alias="2", description='Organization Name Type Code')
    ...
    xon_6: HierarchicDesignator = Field(None, alias="6", description='Assigning Authority')
    xon_7: Identifiertype = Field(None, alias="7", description='Identifier Type Code')
    xon_8: HierarchicDesignator = Field(None, alias="8", description='Assigning Facility')
    xon_9: Name_addressrepresentation = Field(None, alias="9", description='Name Representation Code')
...
class ExtendedCompositeIDNumberandNameforPersons(BaseModel):
    ...
    xcn_4: str = Field(None, alias="4", description='Second And Further Given Names Or Initials Thereof')
    xcn_5: str = Field(None, alias="5", description='Suffix (e.g., Jr Or Iii)')
    xcn_6: str = Field(None, alias="6", description='Prefix (e.g., Dr)')
    xcn_7: Degreeorlicenseorcertificate = Field(None, alias="7", description='Degree (e.g., Md)')
    xcn_8: str = Field(None, alias="8", description='Source Table')
    xcn_9: HierarchicDesignator = Field(None, alias="9", description='Assigning Authority')
    ...
    xcn_14: HierarchicDesignator = Field(None, alias="14", description='Assigning Facility')
    xcn_15: Name_addressrepresentation = Field(None, alias="15", description='Name Representation Code')
    xcn_16: CodedElement = Field(None, alias="16", description='Name Context')
    xcn_17: DateAndTimeRange = Field(None, alias="17", description='Name Validity Range')
    xcn_18: Nameassemblyorder = Field(None, alias="18", description='Name Assembly Order')
    ...
    xcn_22: CodedWithExceptions = Field(None, alias="22", description='Assigning Jurisdiction')
    xcn_23: CodedWithExceptions = Field(None, alias="23", description='Assigning Agency Or Department')