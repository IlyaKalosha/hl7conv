...
class OBR(BaseModel):
    ...
    obr_2: EntityIdentifier = Field(None, alias="2", max_length=22, description="Placer Order Number")
    obr_3: EntityIdentifier = Field(None, alias="3", max_length=22, description="Filler Order Number")
    obr_4: CodedElement = Field(
        ..., alias="4", max_length=250, description="Universal Service Identifier"
    )
    obr_5: str = Field(
        None, alias="5", max_length=2, description="Priority - OBR"
    )
    obr_6: TimeStamp = Field(
        None, alias="6", max_length=26, description="Requested Date/Time"
    )
    obr_7: TimeStamp = Field(None, alias="7", max_length=26, description="Observation Date/Time")
    obr_8: TimeStamp = Field(None, alias="8", max_length=26, description="Observation End Date/Time")
    ...
    obr_12: CodedElement = Field(None, alias="12", max_length=250, description="Danger Code")
    obr_13: str = Field(
    ...
    obr_15: SpecimenSource = Field(None, alias="15", max_length=300, description="Specimen Source")
    ...
    obr_22: TimeStamp = Field(
        None, alias="22", max_length=26, description="Results Rpt/Status Chng - Date/Time"
    )
    obr_23: MoneyAndCode = Field(None, alias="23", max_length=40, description="Charge to Practice")
    obr_24: DiagnosticServiceSectionID = Field(
        None, alias="24", max_length=10, description="Diagnostic Serv Sect ID"
    )
    obr_25: ResultStatus = Field(None, alias="25", max_length=1, description="Result Status")
    obr_26: ParentResultLink = Field(None, alias="26", max_length=400, description="Parent Result")
    obr_27: TimingQuantity = Field(None, alias="27", max_length=200, description="Quantity/Timing")
    obr_28: ExtendedCompositeIDNumberandNameforPersons = Field(
        None, alias="28", max_length=250, description="Result Copies To"
    )
    obr_29: EntityIdentifierPair = Field(None, alias="29", max_length=200, description="Parent")
    obr_30: TransportationMode = Field(
        None, alias="30", max_length=20, description="Transportation Mode"
    )
    obr_31: CodedElement = Field(None, alias="31", max_length=250, description="Reason for Study")
    ...
    obr_34: NameWithDateAndLocation = Field(None, alias="34", max_length=200, description="Technician")
    obr_35: NameWithDateAndLocation = Field(
        None, alias="35", max_length=200, description="Transcriptionist"
    )
    obr_36: TimeStamp = Field(None, alias="36", max_length=26, description="Scheduled Date/Time")
    obr_37: float = Field(None, alias="37", max_length=4, description="Number of Sample Containers")
    obr_38: CodedElement = Field(
        None, alias="38", max_length=250, description="Transport Logistics of Collected Sample"
    )
    obr_39: CodedElement = Field(None, alias="39", max_length=250, description="Collector's Comment")
    obr_40: CodedElement = Field(
        None, alias="40", max_length=250, description="Transport Arrangement Responsibility"
    )
    obr_41: TransportArranged = Field(None, alias="41", max_length=30, description="Transport Arranged")
    obr_42: EscortRequired = Field(None, alias="42", max_length=1, description="Escort Required")
    obr_43: CodedElement = Field(
        None, alias="43", max_length=250, description="Planned Patient Transport Comment"
    )
    obr_44: CodedElement = Field(None, alias="44", max_length=250, description="Procedure Code")
    obr_45: CodedElement = Field(
        None, alias="45", max_length=250, description="Procedure Code Modifier"
    )
    obr_46: CodedElement = Field(
        None, alias="46", max_length=250, description="Placer Supplemental Service Information"
    )
    obr_47: CodedElement = Field(
        None, alias="47", max_length=250, description="Filler Supplemental Service Information"
    )
    obr_48: CodedWithExceptions = Field(
        None, alias="48", max_length=250, description="Medically Necessary Duplicate Procedure Reason"
    )
    ...
    obr_50: CodedWithExceptions = Field(
        None, alias="50", max_length=250, description="Parent Universal Service Identifier"
    )
