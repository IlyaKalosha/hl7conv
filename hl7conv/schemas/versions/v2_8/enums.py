...
class Event_Type(str, Enum):
    ...
    Q34  Get Donor Record Message
    Q32  Find Candidates including Visit Information
    Q33  Get Donor Record Candidates Message
...
class ProcedureCodeModifier(str, Enum):
    """
    340 - Procedure Code Modifier
...
class DiagnosisPriority(str, Enum):
    """
         ...
         2  For ranked secondary diagnosis
    1312
    """
...
class DRGStatusPatient(str, Enum):
    """
    739 - DRG Status Patient
...
class DRGStatusRespirationMinutes(str, Enum):
    """
    757 - DRG Status Respiration Minutes
...
class RelevantClincialInformation(str, Enum):
    """
    916 - Relevant Clincial Information
...
class PreferredSpecimen_AttributeStatus(str, Enum):
    """
    920 - Preferred Specimen-Attribute Status
...
class CertificationCategoryCode(str, Enum):
    """
    922 - Certification Category Code
...
class CumulativeDosageLimitUoM(str, Enum):
    """
    924 - Cumulative Dosage Limit UoM
...
class DonationDurationUnits(str, Enum):
    """
    932 - Donation Duration Units
